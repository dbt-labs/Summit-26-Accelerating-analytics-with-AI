...
- Automatically whenever Wizard builds or changes a model do the following, instead of something I have to ask for every time: preview the resulting data in-thread, show the model's lineage, and run a dbt compare to show what changed.